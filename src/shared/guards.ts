...
export function isLocationMessage(obj: unknown): obj is LocationMessage { return isObject(obj) && isObject(obj.location) && isNumber(obj.location.degreesLatitude) && Math.abs(obj.location.degreesLatitude) <= 90 && isNumber(obj.location.degreesLongitude) && Math.abs(obj.location.degreesLongitude) <= 180; }
...
export function isStickerMessage(obj: unknown): obj is StickerMessage { return media(obj, 'sticker'); }
